                    ...
                    <div class="d-flex align-items-center">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb m-0 p-0">
                                ...
                                <li class="breadcrumb-item text-muted active" aria-current="page">Mata Kuliah</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h6 class="card-subtitle mb-4">Manajemen daftar mata kuliah.</h6>

                            <div class="table-responsive">
                                <table id="table-makul" class="table table-striped table-bordered" style="width: 100%">
                                    <thead>
                                        <tr>
                                            <th style="width: 5%">No</th>
                                            <th style="width: 15%">Kode Makul</th>
...
@push('scripts')
    ...
    <script>
        let table;
        $(function() {
            table = $('#table-makul').DataTable({
                responsive: true,
                scrollX: true,
                processing: true,
                serverSide: true,
                ajax: '{{ route('makul.data') }}',
                columns: [{
                        data: 'DT_RowIndex',
                        searchable: false,
                        sortable: false,
        ...
        function deleteData(url) {
            Swal.fire({
                ...
                text: "Mata kuliah yang dihapus tidak bisa dikembalikan!",
                icon: 'warning',
