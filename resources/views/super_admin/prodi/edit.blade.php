        ...
        <div class="page-breadcrumb">
            <div class="row">
                <div class="col-7 align-self-center">
                    <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Edit Prodi</h4>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        <h4 class="card-title m-0">Form Edit Program Studi</h4>
                    </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control @error('kode') is-invalid @enderror"
                                        name="kode" value="{{ old('kode', $prodi->kode) }}" required>
                                    @error('kode')
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control @error('nama_prodi') is-invalid @enderror"
                                        name="nama_prodi" value="{{ old('nama_prodi', $prodi->nama_prodi) }}" required>
                                    @error('nama_prodi')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <select class="form-control select2 @error('akreditasi') is-invalid @enderror"
                                        ...
                                        <optgroup label="Standar Baru">
                                            <option value="Unggul"
                                                {{ old('akreditasi', $prodi->akreditasi) == 'Unggul' ? 'selected' : '' }}>
                                                Unggul</option>
                                            <option value="Baik Sekali"
                                                {{ old('akreditasi', $prodi->akreditasi) == 'Baik Sekali' ? 'selected' : '' }}>
                                                Baik Sekali</option>
                                            <option value="Baik"
                                                {{ old('akreditasi', $prodi->akreditasi) == 'Baik' ? 'selected' : '' }}>
                                                Baik</option>
                                        </optgroup>
                                        <optgroup label="Standar Lama">
                                            <option value="A"
                                                {{ old('akreditasi', $prodi->akreditasi) == 'A' ? 'selected' : '' }}>A
                                            </option>
                                            <option value="B"
                                                {{ old('akreditasi', $prodi->akreditasi) == 'B' ? 'selected' : '' }}>B
                                            </option>
                                            <option value="C"
                                                {{ old('akreditasi', $prodi->akreditasi) == 'C' ? 'selected' : '' }}>C
                                            </option>
                                        </optgroup>
                                        <option value="Belum Ada"
                                            {{ old('akreditasi', $prodi->akreditasi) == 'Belum Ada' ? 'selected' : '' }}>
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <div class="position-relative">
                                        <input type="text"
                                            ...
                                            value="{{ old('tanggal_berdiri', $prodi->tanggal_berdiri) }}"
